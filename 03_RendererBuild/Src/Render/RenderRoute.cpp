...
void RenderRoute::loop()
{
	...
	//std::string meshfile = "D:/z_Work/-QtSoftRenderer-/03_RendererBuild/Concent/Model/Cube.obj";
	//vec3 translate = vec3{ 0,0,3 };
	//vec3 rotate = vec3{ 40 * 3.14 / 180.f,0,0 };//220 * 3.14 / 180.f;
	...
	//std::string diffusefile = "D:/z_Work/-QtSoftRenderer-/03_RendererBuild/Concent/Texture/F.tga";
